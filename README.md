...
As a data analyst, I want to analyze historical space mission data, so that I can identify trends and patterns in rocket launches, mission success rates, and launch locations to provide actionable insights for future space exploration initiatives.
...
The data is sourced from Maven Analytics (an Excel extract). [See here to find it.](https://app.mavenanalytics.io/datasets)
...
- **General Approach:**
  ...
  7. Write the documentation and commentary.
...
- **Initial Observations:**
  1. There are at least 9 columns that contain the data we need for this analysis, which signals we have everything we need from the file without needing to contact the client for more data.
...
- **Expected Clean Data:**
  ...
  - Null cells should be addressed appropriately.
  - Data types should be checked to ensure fields correlate with records.
...
- **Dashboard Preview:**
  ...
  ![GIF of Power BI Dashboard](Asset/Images/Dashboardvideo.gif)
...
For this analysis, we focus on the following questions:
...
4. **Are there any patterns you can notice with the launch locations?**
   ...
   - The United States of America has the record for the most missions launched.
